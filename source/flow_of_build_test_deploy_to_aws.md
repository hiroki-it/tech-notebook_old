...
CloudFront，ALBに，，SSLサーバ証明書を置くことで，HTTPSプロトコルの使用が可能になる．
...
### ALB：Application Load Balancing（＝リバースプロキシサーバ）

#### ・ALBとは

リバースプロキシサーバとして働く．リクエストを代理で受信し，インスタンスへのアクセスをバランスよく分配することによって，サーバへの負荷を緩和する．機能別に，3種類に分類できる．
