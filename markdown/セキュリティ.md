...
- [05-01. その他のセキュリティ技術](#05-01-その他のセキュリティ技術)
    - [:pushpin: アクセスキーとアクセストークン](#pushpin-アクセスキーとアクセストークン)
...
### :pushpin: APIキーとアクセストークン

1. クライアントが，HTTPリクエストにIDとパスワードを追加してリクエスト．
2. アイデンティティプロバイダー（IdP）がIDを認証して認証されたクライアントにアクセストークンを発行．
3. クライアントが，HTTPリクエストにアクセストークンを追加してリクエスト．
4. APIから，データがレスポンスされる．

![APIキーとアクセストークンによるセキュリティ](https://raw.githubusercontent.com/Hiroki-IT/tech-notebook/master/markdown/image/APIキーとアクセストークンによるセキュリティ.jpg)
