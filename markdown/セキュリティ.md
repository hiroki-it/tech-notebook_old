...
![Macroウイルス](C:\Projects\tech-notebook\markdown\image\Macroウイルス.jpg)
...
![Worm（共有フォルダ）](C:\Projects\tech-notebook\markdown\image\Worm（共有フォルダ）.jpg)
...
![トロイの木馬](C:\Projects\tech-notebook\markdown\image\トロイの木馬.jpg)
...
![スパイウェア](C:\Projects\tech-notebook\markdown\image\スパイウェア.png)
...
- **パソコンがボット化するまでのプロセス**
  ...
  ![ボット化のプロセス（パソコン）](C:\Projects\tech-notebook\markdown\image\ボット化のプロセス（パソコン）.jpg)

- **スマホがボット化するまでのプロセス**

  ![ボット化のプロセス（スマホ）](C:\Projects\tech-notebook\markdown\image\ボット化のプロセス（スマホ）.jpg)

- **Bot の使われ方**

  まず、攻撃対象のネットワーク内にあるパソコンをBot化させる。攻撃者は、Bot化したパソコンを踏み台としてサーバーを攻撃させるように、C&Cサーバーに命令を出す。

![C&Cサーバー](C:\Projects\tech-notebook\markdown\image\C&Cサーバー.png)
...
![ファイアウォール_ips_ids_waf](C:\Projects\tech-notebook\markdown\image\ファイアウォール_ips_ids_waf.png)
...
![パケットフィルタリング](C:\Projects\tech-notebook\markdown\image\パケットフィルタリング.gif)

**【具体例】**

Win10における設定画面

![パケットフィルタリングの設定](C:\Projects\tech-notebook\markdown\image\パケットフィルタリングの設定.gif)
...
![IDS](C:\Projects\tech-notebook\markdown\image\IDS.png)
...
![IPS](C:\Projects\tech-notebook\markdown\image\IPS.png)
...
![WAF](C:\Projects\tech-notebook\markdown\image\WAF.png)
...
![DoS攻撃](C:\Projects\tech-notebook\markdown\image\DoS攻撃.png)
...
![SQLインジェクション](C:\Projects\tech-notebook\markdown\image\SQLインジェクション.jpg)
...
![Cross Cite Scripting](C:\Projects\tech-notebook\markdown\image\Cross Cite Scripting.png)
...
![ディレクトリトラバーサル](C:\Projects\tech-notebook\markdown\image\ディレクトリトラバーサル.jpg)
...
![パスワードリスト攻撃](C:\Projects\tech-notebook\markdown\image\パスワードリスト攻撃.png)
...
![Brute-force攻撃とReverse Brute-force攻撃](C:\Projects\tech-notebook\markdown\image\Brute-force攻撃とReverse Brute-force攻撃.png)

- **パスワードのパターン数**

![パスワードのパターン数](C:\Projects\tech-notebook\markdown\image\パスワードのパターン数.png)
...
![Rainbow攻撃](C:\Projects\tech-notebook\markdown\image\Rainbow攻撃.png)
...
![ソーシャルエンジニアリング](C:\Projects\tech-notebook\markdown\image\ソーシャルエンジニアリング.png)
...
![DNSキャッシュポイズニング](C:\Projects\tech-notebook\markdown\image\DNSキャッシュポイズニング.gif)
...
![バックドア](C:\Projects\tech-notebook\markdown\image\バックドア.png)
...
![盗聴_改竄_成りすまし](C:\Projects\tech-notebook\markdown\image\盗聴_改竄_成りすまし_1.png)

### ◆ 改竄（データの書き換え）を防ぐ

『ハッシュ関数』によって実現される。相手に送ったデータと相手が受け取ったデータが同じかどうかを確認することによって、改竄を防ぐ。

![盗聴_改竄_成りすまし](C:\Projects\tech-notebook\markdown\image\盗聴_改竄_成りすまし_2.png)

### ◆ 成りすましを防ぐ

『デジタル署名』によって実現される。正しい相手であることを証明することによって、成りすましを防ぐ。

![盗聴_改竄_成りすまし](C:\Projects\tech-notebook\markdown\image\盗聴_改竄_成りすまし_3.png)
...
![暗号方式の種類](C:\Projects\tech-notebook\markdown\image\暗号方式の種類.png)
...
![p437](C:\Projects\tech-notebook\markdown\image\p437.png)



### ◆ 公開鍵暗号方式

![公開鍵暗号方式](C:\Projects\tech-notebook\markdown\image\公開鍵暗号方式.png)
...
共通鍵暗号方式と公開鍵暗号方式を組み合わせた暗号方式。両方の方式の長所と短所を補う。
 ...
 ![ハイブリッド暗号](C:\Projects\tech-notebook\markdown\image\ハイブリッド暗号.png)
...
![デジタル署名](C:\Projects\tech-notebook\markdown\image\デジタル署名.png)
...
![ハッシュ関数](C:\Projects\tech-notebook\markdown\image\ハッシュ関数.png)
...
![デジタル署名と暗号化](C:\Projects\tech-notebook\markdown\image\デジタル署名と暗号化.png)
...
![デジタル証明書（SSLサーバ証明書）](C:\Projects\tech-notebook\markdown\image\デジタル証明書（SSLサーバ証明書）.gif)
...
![認証局自体の成りすまし防止](C:\Projects\tech-notebook\markdown\image\認証局自体の成りすまし防止.png)
...
![セキュアプロトコル](C:\Projects\tech-notebook\markdown\image\セキュアプロトコル.jpg)
...
公開鍵暗号方式に基づく技術。アプリにおいて、デジタル署名による認証の機能を、メールに追加することができる。
 ...
 ![S_MIME](C:\Projects\tech-notebook\markdown\image\S_MIME.png)
...
![ssh接続](C:\Projects\tech-notebook\markdown\image\ssh接続.png)
...
![SSLによるインターネットVPN](C:\Projects\tech-notebook\markdown\image\SSLによるインターネットVPN.jpg)

**【具体例】**

Chromeでは、SSL接続に不備があると、以下のような警告が表示される。

![SSL接続に不備がある場合の警告](C:\Projects\tech-notebook\markdown\image\SSL接続に不備がある場合の警告.jpg)
...
![VPN（ネットワーク間）](C:\Projects\tech-notebook\markdown\image\VPN（ネットワーク間）.png)
...
![IPsecによるインターネットVPN](C:\Projects\tech-notebook\markdown\image\IPsecによるインターネットVPN.jpg)

- **IPsecによるパケットのカプセル化**

![IPsecによるカプセル化](C:\Projects\tech-notebook\markdown\image\IPsecによるカプセル化.jpg)
...
![ハッシュ値で保存](C:\Projects\tech-notebook\markdown\image\ハッシュ値で保存.png)



### ◆ 生体認証

![生体認証-1](C:\Projects\tech-notebook\markdown\image\生体認証-1.png)



![生体認証-2](C:\Projects\tech-notebook\markdown\image\生体認証-2.png)
...
![ペネトレーションテスト](C:\Projects\tech-notebook\markdown\image\ペネトレーションテスト.png)
...
![情報セキュリティ３要素](C:\Projects\tech-notebook\markdown\image\情報セキュリティ３要素.jpg)
