...
![ドメイン駆動設計_逆転依存性の原則](image\ドメイン駆動設計_依存性逆転の原則.jpg)
...
![ドメイン駆動設計_エンティティ](image\ドメイン駆動設計_エンティティ.jpg)
...
![ドメイン駆動設計_集約関係](image\ドメイン駆動設計_集約関係.jpg)
...
![ドメイン駆動設計_バリューオブジェクト](image\ドメイン駆動設計_バリューオブジェクト.jpg)
...
3. データベースに追加する。
4. ![ドメイン駆動設計_リポジトリ_データ更新](image\ドメイン駆動設計_リポジトリ_データ更新.png)
...
![ドメイン駆動設計_リポジトリ_データ取得](image\ドメイン駆動設計_リポジトリ_データ取得.jpg)
