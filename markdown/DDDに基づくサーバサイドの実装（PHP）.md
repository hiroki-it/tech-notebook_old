...
- [05-03. ValueObject](#05-03-valueobject)
    - [◆ 責務](#◆-責務-1)
    - [◆ 一意に識別できるプロパティをもたず、対象のユビキタス言語に関するプロパティをメソッドを持つ](#◆-一意に識別できるプロパティをもたず対象のユビキタス言語に関するプロパティをメソッドを持つ)
    - [◆ プロパティの不変性](#◆-プロパティの不変性)
    - [◆ 概念的な統一体](#◆-概念的な統一体)
    - [◆ オブジェクトの交換可能性](#◆-オブジェクトの交換可能性)
    - [◆ オブジェクト間の等価性](#◆-オブジェクト間の等価性)
    - [◆ メソッドによってオブジェクトの状態が変わらない](#◆-メソッドによってオブジェクトの状態が変わらない)
...
- [06-01. Infrastructure層のRepository](#06-01-infrastructure層のrepository)
    - [◆ 集約の構成／DBへのデータのCreate](#◆-集約の構成／dbへのデータのcreate)
    - [◆ DBにおけるデータのRead／集約の再構成](#◆-dbにおけるデータのread／集約の再構成)
...
### ◆ 一意に識別できるプロパティをもたず、対象のユビキタス言語に関するプロパティをメソッドを持つ
