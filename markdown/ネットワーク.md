...
Webサーバソフトウェア（Apache、Nginxなど）がインストールされている。Webブラウザから動的コンテンツのリクエストがあった場合に、アプリケーションサーバにリクエストを行う。アプリケーションサーバからレスポンスを受け取り、Webブラウザにレスポンスを行う。
...
例えば、プライベートIPアドレスの４つの各区分が１Byteの容量をもち、IPアドレス全体で４Byteの容量をもつ。
