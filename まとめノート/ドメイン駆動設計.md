...
※Domain層とInfrastructure層の依存関係がわからないので、質問する。



### ◇ 依存性逆転の原則に基づく実装

RepositoryのInterfaceは、ドメイン層に配置する。そしてRepositoryの実装クラスはInfrastructure層に配置します。依存性逆転の原則に基づくことによって、ドメイン層への影響なく、Repositoryの交換が可能になります。

※『依存』：そのオブジェクトが起動して、初めて起動できるような関係。

![ドメイン駆動設計_逆転依存性の原則](D:\Documents\Drive 1st\プログラミング自習\まとめノート\画像\ドメイン駆動設計_逆転依存性の原則.jpg)
...
![ドメイン駆動設計_エンティティ](D:\Documents\Drive 1st\プログラミング自習\まとめノート\画像\ドメイン駆動設計_エンティティ.jpg)
...
![ドメイン駆動設計_バリューオブジェクト](D:\Documents\Drive 1st\プログラミング自習\まとめノート\画像\ドメイン駆動設計_バリューオブジェクト.jpg)
...
![ドメイン駆動設計_集約関係](D:\Documents\Drive 1st\プログラミング自習\まとめノート\画像\ドメイン駆動設計_集約関係.jpg)
...
![ドメイン駆動設計_リポジトリ（DBから取得）](D:\Documents\Drive 1st\プログラミング自習\まとめノート\画像\ドメイン駆動設計_リポジトリ（DBから取得）.jpg)
