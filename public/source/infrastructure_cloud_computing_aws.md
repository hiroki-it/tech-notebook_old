...
| Associated AWS resources | WAFをアタッチするサービスを設定する．                        | 多くの場合，CloudFrontのセキュリティグループとして設定する． |
| Logging and metrics      |                                                              |                                                              |
...
AWSが提供しているポリシーのこと．すでにアタッチされていても，他のものにもアタッチできる．
...
単一のIAMユーザ，IAMグループ，IAMロール，に付与するためのポリシーのこと．すでにアタッチされていると，他のものにはアタッチできない．
...
IAMユーザ，IAMグループ，IAMロールは，全てのAWSのリソースに，任意のアクションを実行できる．
...
単一のAWSリソースに付与するためのインポリシーのこと．すでにアタッチされていると，他のものにはアタッチできない．
...
Assume Roleを行うために必要なインラインポリシーのこと．
