...
![仮想メモリとのマッピングによる大容量アドレス空間の再現](C:\Projects\summary_notes\SummaryNotes\Image\仮想メモリとのマッピングによる大容量アドレス空間の再現.png)
...
MMUによって、仮想メモリのアドレス空間は、物理メモリのアドレス空間に変換される。この仕組みを、『動的アドレス変換機構』と呼ぶ。
